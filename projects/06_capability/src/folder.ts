/**
 * Folder-based capability.
 *
 * Binds the logical model to the filesystem:
...
const IGNORE = new Set([
  'node_modules', '.git', 'dist', '.mycelium', '.changelog',
]);
...
export class FolderCapability implements Capability {
